const VENUE_ABBR: [RegExp, string][] = [
    ...
    [/(Conference on Knowledge Discovery and Data Mining|(^|\W)KDD(\W|$))/i, "KDD"],
...
/** 顶尖会议/期刊缩写定义（Tier1） */
const TOP_TIER = new Set(["MICRO","PLDI","ISCA","ASPLOS","NeurIPS","ICML","CVPR","ICCV","ECCV","SIGMOD","VLDB","WWW","SC","SIGGRAPH","FAST","OSDI","ASE","FSE","ICSE","SOSP","SIGCOMM","NSDI","KDD","AAAI","IJCAI","TOSEM","SIGIR","OOPSLA","TOIS","CCS","ISSTA","POPL","SPLASH","TACO","TOCS","TOIS","TPDS","TC","TCAD","TCC","JETC","USENIX","TOPLAS","ICLR","EuroSys","KDD","PPoPP"]);
